...
public class DelegateExecutors  {

//    public static ExecutorService newCachedThreadPool(String invokePointerName) {
//        return new DelegateThreadPoolExecutor(0, 2147483647, 60L, TimeUnit.SECONDS,
//                new SynchronousQueue(), invokePointerName);
//    }
